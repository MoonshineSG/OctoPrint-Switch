...
plugin_identifier = "switch"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_switch"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint Switch"
...
# module
plugin_description = """GPIO controled switches and some more..."""
...
plugin_url = "https://github.com/MoonshineSG/OctoPrint-Switch"
